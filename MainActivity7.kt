...
import com.example.myfan.MainActivity4
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            Column {
                ...
                Text(text = "Incorrect,Cleopatra was a famous queen of Ancient Egypt.")
                Button(onClick = {
                    val next = Intent(this@MainActivity7, MainActivity8::class.java)
                    startActivity(next)
                }) {
                    Text(text = "Next")
                }
