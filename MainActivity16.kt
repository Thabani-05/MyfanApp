...
import com.example.myfan.MainActivity12
        ...
        setContent {
            ...
            Row {
                Column {
                    ...
                    Text(text = "Incorrect,Apartheid in South Africa officially ended in 1994.")
                    Button(onClick = {
                        val Review = Intent(this@MainActivity16, MainActivity17::class.java)
